...
下面我将基于 Python 实现上述多状态模拟策略，完整的源代码见[python-nfa]()，文章的该部分在很大程度上借鉴了文章[Regular Expression Matching Can Be Simple And Fast (but is slow in Java, Perl, PHP, Python, Ruby, ...)](https://swtch.com/~rsc/regexp/regexp1.html)的实现思路。
